...
import { buildLinkGraph, resolveLink, integrityReport } from './link-graph.js';
...
function getLinkGraph() {
    if (!linkGraph)
        linkGraph = buildLinkGraph(VAULT_PATH);
    return linkGraph;
}
...
console.error(`Smart Connections index: ${loader.getSourceCount()} entries ` +
