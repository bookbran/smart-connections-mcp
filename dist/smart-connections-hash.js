...
function murmurHash32(input, seed = 0) {
 ...
 */
export function smartConnectionsHash(rawContent) {
...
export function verifyPluginSource(source, modelKey, rawContent) {
    ...
    if (readHash !== current || importHash !== current)
        return 'embed-incomplete';
    return 'verified-current';
}
//# sourceMappingURL=smart-connections-hash.js.map