...
if (hygiene.orphans.length) {
    ...
    for (const o of hygiene.orphans.slice(0, 8))
        console.log(`   - ${o}`);
    if (hygiene.orphans.length > 8)
        console.log(`   ... and ${hygiene.orphans.length - 8} more`);
}
...
if (fmPct > 50) {
    ...
    for (const f of hygiene.missingFrontmatter.slice(0, 5))
        console.log(`   - ${f}`);
}
