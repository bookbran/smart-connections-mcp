 ...
 */
export declare const CONTENT_HASH_ALGORITHM = "canonical-markdown-sha256-v1";
/**
 ...
 */
export declare function canonicalizeMarkdown(raw: string): string;
/** Hash of already-canonical text. Use when you are holding the exact string you embedded. */
export declare function hashCanonicalText(canonical: string): string;
/**
 ...
 */
export declare function canonicalContentHash(raw: string): {
    canonical: string;
    hash: string;
};
...
export declare function fingerprint(hash: string): ContentFingerprint;
/**
 ...
 * fine."
 */
export declare function fingerprintMatches(stored: Partial<ContentFingerprint> | undefined | null, currentHash: string): boolean;
